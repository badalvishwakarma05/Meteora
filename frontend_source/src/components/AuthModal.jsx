...
export default function AuthModal({ isOpen, onClose, initialMode = 'login' }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      ...
      >
        {/* Top Header */}
        <div className="flex items-center justify-between p-5 border-b border-[#1a3a6b] bg-[#0a1628]">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold bg-[#00d4ff] text-[#050d1a]">
              IMD
            </div>
            <div>
              <div className="text-xs font-bold tracking-widest text-white font-mono">METEORA Access Gateway</div>
              <div className="text-[11px] text-[#88a0c0] font-mono">Ministry of Earth Sciences · MoES / IMD</div>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 max-h-[80vh] overflow-y-auto font-mono">
          {error && (
            <div className="mb-4 p-3 rounded-lg flex items-start gap-2 text-xs border border-red-500/50 bg-red-950/40 text-red-300">
          ...
          <div className="mb-5 p-3 rounded-lg border border-[#1a3a6b] bg-[#0a1628]">
            <div className="text-[11px] font-bold text-[#88a0c0] uppercase tracking-wider mb-2 flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="text-xs px-2.5 py-1.5 rounded border border-[#1a3a6b] bg-[#0d1f3c] text-left transition-all hover:border-cyan-500/50 cursor-pointer"
              >
                <div className="font-semibold text-white truncate">Dr. M. Kumar</div>
                <div className="text-[10px] text-[#88a0c0] truncate">Senior Meteorologist</div>
              </button>
              <button
                type="button"
                ...
                className="text-xs px-2.5 py-1.5 rounded border border-[#1a3a6b] bg-[#0d1f3c] text-left transition-all hover:border-cyan-500/50 cursor-pointer"
              >
                <div className="font-semibold text-white truncate">Disaster Admin</div>
                <div className="text-[10px] text-[#88a0c0] truncate">MoES HQ Authority</div>
              </button>
            </div>
          </div>
          ...
          {mode === 'login' ? (
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 rounded-lg border border-[#1a3a6b] bg-[#0a1628] text-sm text-white focus:outline-none focus:border-[#00d4ff] font-sans"
                  />
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-xs text-[#88a0c0] font-medium block">Password</label>
                  <span className="text-[11px] text-[#00d4ff] cursor-pointer hover:underline"
              ...
              <div className="flex items-center justify-between text-xs text-[#88a0c0]">
                <label className="flex items-center gap-1.5 cursor-pointer">
                  <input type="checkbox" defaultChecked className="accent-[#00d4ff] rounded" />
                  <span>Remember session</span>
                </label>
                <span className="hover:text-white cursor-pointer">Station authorization guide</span>
              </div>

              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 rounded-lg font-bold text-sm text-[#050d1a] flex items-center justify-center gap-2 transition-all hover:bg-cyan-300 disabled:opacity-50 bg-[#00d4ff] cursor-pointer shadow-lg shadow-cyan-500/20"
              >
            ...
            <form onSubmit={handleSignupSubmit} className="space-y-3.5 font-mono">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-1.5 rounded-lg border border-[#1a3a6b] bg-[#0a1628] text-sm text-white focus:outline-none focus:border-[#00d4ff] font-sans"
                  />
                </div>
              </div>

              <div>
                <label className="text-xs text-[#88a0c0] font-medium block mb-1">Official Email (@imd.gov.in / @moes.gov.in)</label>
                <div className="relative">
                  <Mail size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#88a0c0]" />
                  <input
                    type="email"
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-2.5 py-1.5 rounded-lg border border-[#1a3a6b] bg-[#0a1628] text-xs text-white"
                  >
              ...
              <div className="text-[11px] text-[#88a0c0] flex items-start gap-1.5 pt-1">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 rounded-lg font-bold text-sm text-[#050d1a] flex items-center justify-center gap-2 transition-all hover:bg-cyan-300 disabled:opacity-50 mt-2 bg-[#00d4ff] cursor-pointer shadow-lg shadow-cyan-500/20"
              >
        ...
        {/* Footer Note */}
        <div className="px-6 py-3 text-center border-t border-[#1a3a6b] text-[11px] text-[#88a0c0] bg-[#0a1628] font-mono">
